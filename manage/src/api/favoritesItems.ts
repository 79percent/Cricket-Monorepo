...
// 添加作品到收藏夹
export const favoriteWorkAPI = (data: any) => {
...
// 删除
export const deleteFavoriteWorkAPI = (data: any) => {
...
// 获取收藏夹下的作品列表
export const getFavoriteItemsListAPI = (params: any) => {
...
// 获取作品被收藏至哪些收藏夹下
export const getWorkFavoriteAPI = (params: any) => {
...
// 获取作品的收藏数
export const getFavoritesCountAPI = (params: any) => {
