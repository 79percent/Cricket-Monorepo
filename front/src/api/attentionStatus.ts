...
// 更新状态
export const updateAttentionAPI = (data) => {
...
// 取消关注
export const deleteAttentionAPI = (data) => {
...
// 获取用户关注列表
export const getAttentionListAPI = (params) => {
...
// 获取粉丝列表
export const getFansListAPI = (params) => {
...
// 获取所有关注用户id
export const getAllAttentionAPI = (params) => {
